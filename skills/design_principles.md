...
### 絶対ルール
- **objects と images を同一スライドに混在させない**（競合してレイアウトが崩壊する）
- objects がメッセージの核を担う場合、images は「飾り」でしかないので不要
- images は「言葉や図では伝わらない視覚的概念」が必要な場合にだけ使う
- agenda / chapter / end には images を入れない（装飾過多）
...
- [ ] objects と images が同一スライドで競合していないか？
...
- [ ] agenda / chapter / end に不要な images を入れていないか？
